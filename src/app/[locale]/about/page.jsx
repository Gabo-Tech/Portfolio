...
const ABOUT_IMAGE_URLS = [
  ...
  "/images/arturorodes.png",
];

/**
 * AboutPage: biography, skills, languages, and experience.
 */
const AboutPage = () => {
  ...
  /**
   * Rotation progress is driven by the experience section's own position in the
   * viewport: 0 when it first enters from below, 1 when it leaves at the top.
   * Works whether the document or `#app-scroll-root` is the real scrollport.
   */
  ...
  return (
    <>
      ...
      <div className="relative z-10 flex flex-col gap-24 p-4 text-stone-100 page-gradient sm:p-6 md:gap-32 md:p-10 lg:gap-48 lg:p-16 xl:gap-64 xl:p-20 2xl:p-24">
          ...
          <div
            className="relative flex flex-col gap-12 pb-24 lg:grid lg:grid-cols-2 lg:gap-x-12"
            ref={experienceRef}
          >
            <motion.h1
              initial={{ x: "-300px", opacity: 0 }}
            ...
            {/* Desktop: Brain pinned vertically-centered for the entire
                experience section (releases when testimonials are reached). */}
